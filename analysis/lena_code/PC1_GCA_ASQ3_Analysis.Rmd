...
diagnose_data <- function() {
  ...
  # Vérifier les époques
  cat("Époques dans les données:\n")
  ...
  # Vérifier les données ASQ3 par époque
  cat("\nDonnées ASQ3 par époque:\n")
  ...
  # Vérifier les sujets par époque
  cat("\nNombre de sujets par époque:\n")
...
analyze_asq3_moderator <- function(asq3_domain) {
  ...
  # Vérification des époques disponibles
  epochs <- unique(subset_data$epoch)
  cat("Époques disponibles:", paste(epochs, collapse = ", "), "\n")
  
  if (nrow(subset_data) > 20) {  # Seuil minimum de données
    
    # STOCKAGE DES RÉSULTATS POUR CHAQUE ÉPOQUE
    epoch_results <- list()
    ...
    for (epoch_val in epochs) {
      ...
      cat("Nombre d'observations pour époque", epoch_val, ":", nrow(epoch_data), "\n")
      cat("Nombre de sujets pour époque", epoch_val, ":", length(unique(epoch_data$subject)), "\n")
      ...
      if (nrow(epoch_data) > 10) {
        ...
        if (length(unique_values) > 2) {
          ...
          tryCatch({
            ...
            if (length(sig_results$significant_effects) > 0) {
              for (effect in sig_results$significant_effects) {
                ...
                cat("- ", effect, " (?² = ", round(effect_row$ChiSq, 3), 
            ...
            # Sauvegarder les résultats de cette époque
              ...
              if (any(grepl(paste0("poly1.*", asq3_domain, "|", asq3_domain, ".*poly1"), interaction_effects))) {
                ...
                tryCatch({
                  ...
                  jn_poly1$plot <- jn_poly1$plot + 
                    labs(title = paste("Interaction poly1 ×", asq3_domain, "- Époque:", epoch_val),
              ...
              if (any(grepl(paste0("poly2.*", asq3_domain, "|", asq3_domain, ".*poly2"), interaction_effects))) {
                ...
                tryCatch({
                  ...
                  jn_poly2$plot <- jn_poly2$plot + 
                    labs(title = paste("Interaction poly2 ×", asq3_domain, "- Époque:", epoch_val),
            ...
            if (length(interaction_effects) > 0) {
              ...
              tryCatch({
                ...
                p_interaction <- ggplot(epoch_data, aes(x = age, y = PC1, color = asq3_level)) +
                  ...
                  labs(title = paste("Interaction Age ×", asq3_domain, "- Époque:", epoch_val),
                       x = "Âge (mois)", y = "PC1",
            ...
            cat("? Erreur modèle pour époque", epoch_val, ":", e$message, "\n")
            epoch_results[[epoch_val]] <- list(
              error = e$message,
              epoch = epoch_val,
              domain = asq3_domain,
          ...
          cat("? Variable ASQ3 pas assez variable pour cette époque (", length(unique_values), " valeurs uniques)\n")
          epoch_results[[epoch_val]] <- list(
        ...
        cat("? Données insuffisantes pour époque", epoch_val, "(n =", nrow(epoch_data), ")\n")
        epoch_results[[epoch_val]] <- list(
    ...
    # RETOURNER TOUS LES RÉSULTATS D'ÉPOQUES
          ...
          tryCatch({
            ...
            if (length(interaction_effects) > 0) {
              ...
              tryCatch({
                ...
                p_interaction <- ggplot(epoch_data, aes(x = age, y = PC2, color = asq3_level)) +
                  geom_smooth(method = "loess", se = TRUE) +
                  geom_point(alpha = 0.5) +
                  labs(title = paste("Interaction Age ×", asq3_domain, "- Époque:", epoch_val),
                       x = "Âge (mois)", y = "PC2",
          ...
          tryCatch({
            ...
            if (length(interaction_effects) > 0) {
              ...
              tryCatch({
                ...
                p_interaction <- ggplot(epoch_data, aes(x = age, y = PC3, color = asq3_level)) +
                  geom_smooth(method = "loess", se = TRUE) +
                  geom_point(alpha = 0.5) +
                  labs(title = paste("Interaction Age ×", asq3_domain, "- Époque:", epoch_val),
                       x = "Âge (mois)", y = "PC3",
          ...
          tryCatch({
            ...
            if (length(interaction_effects) > 0) {
              ...
              tryCatch({
                ...
                p_interaction <- ggplot(epoch_data, aes(x = age, y = PC7, color = asq3_level)) +
                  geom_smooth(method = "loess", se = TRUE) +
                  geom_point(alpha = 0.5) +
                  labs(title = paste("Interaction Age ×", asq3_domain, "- Époque:", epoch_val),
                       x = "Âge (mois)", y = "PC7",
...
p_main <- ggplot(summary_data, aes(x = age, y = mean_PC8, color = epoch)) +
  ...
  geom_errorbar(aes(ymin = mean_PC8 - se_PC8, ymax = mean_PC8 + se_PC8), 
                width = 0.2) +
  labs(title = "Évolution moyenne de PC8 par âge et époque",
...
p_main <- ggplot(summary_data, aes(x = age, y = mean_PC9, color = epoch)) +
  ...
  geom_errorbar(aes(ymin = mean_PC9 - se_PC9, ymax = mean_PC9 + se_PC9), 
                width = 0.2) +
  labs(title = "Évolution moyenne de PC9 par âge et époque",
...
p_main <- ggplot(summary_data, aes(x = age, y = mean_PC10, color = epoch)) +
  ...
  geom_errorbar(aes(ymin = mean_PC10 - se_PC10, ymax = mean_PC10 + se_PC10), 
                width = 0.2) +
  labs(title = "Évolution moyenne de PC10 par âge et époque",
